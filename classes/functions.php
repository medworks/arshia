<?php
	...
	{	   
		...
		switch($func)
		{
			...
			break;
			case 'picslist':
                if ($act=="do" or  $act=="new" or $act=="edit") return "../manager/picslist.php";
			break;
			case 'uploadmgr':
     ...
     function SendSmtpEmail($senderemail,$sendername,$receivers, $subject, $message,$host,$port,$username,$password)
      {
        ...
        {
            $option = "<select name='$optionname' class='$classname' id='$optionname' onchange='$onchange' style='float:right' >";
