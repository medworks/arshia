								...
								<div class="col">
									<div class="grid">
										<div class="col-content">
											<div class="col">
												<article class="page-1_container main_column">
													<div class="page-1_wrapper">
														<div class="page-1 content_cols_eq">
															<div class="post_content">
																...
																<br>
																<div class="page404">
																	<h2 class="page404_title" style="font-family:arial">404</h2>
																	<p class="page404_desc">
																		متاسفانه صفحه مورد نظر شما یافت نشد. لطفا از تایپ صحیح آدرس در مرورگر خود اطمینان حاصل نمایید.	
																	</p>
																	<form action="" class="searchform clearfix" method="get">
																		<div class="search_wrapper">
																			...
																			<p><input type="text" placeholder="جستجو..." autocomplete="off" name="s" class="searchfield nooutline"></p>
																		</div>
																	</form>
																	<a href="./" class="sc_button sc_button_round sc_button_small sc_button_blue">بازگشت به صفحه اصلی</a>
																</div>
																<br>
																<br>
																<br>
