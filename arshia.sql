...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2015 at 12:26 PM
...
(2, 2, 'error.png', '<p>ماموریشت شرکت ارشیا</p>'),
(3, 5, 'about_pic.jpg', '<p>چارت سازمانی شرکت ارشیا گستر</p>');
...
--
-- Table structure for table `topindex`
--

CREATE TABLE IF NOT EXISTS `topindex` (
`id` int(11) NOT NULL,
  `mid` int(11) NOT NULL,
  `pic` varchar(100) NOT NULL,
  `subject` varchar(50) NOT NULL,
...
--
-- Indexes for table `topindex`
--
ALTER TABLE `topindex`
 ADD PRIMARY KEY (`id`);
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `topindex`
--
ALTER TABLE `topindex`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
